...
#project_dir = os.path.join("/Volumes/External/mimic_v9_4s")
project_dir = "/data2/mimic"
...
preprocessed_data_dir = os.path.join(project_dir, "ABP_with_Med_data/patients")
...
window_save_dir = os.path.join(project_dir, "ABP_with_Med_data/patients/results2/npy")

# window filtering stats file directory
stats_file_dir = os.path.join(project_dir, "ABP_with_Med_data/patients/window_stats")
...
invalid_window_images = os.path.join(project_dir, "ABP_with_Med_data/patients/invalid_window_images")
# directory to save images of valid windows
valid_window_images = os.path.join(project_dir, "ABP_with_Med_data/patients/valid_window_images")
